 ...
 * @author david
 */
public class diplomaAlerts extends javax.swing.JDialog {

    ImageIcon hoverBtnCloseIcon, defaultBtnCloseIcon, hoverBtnOkIcon, defaultBtnOKIcon;
    /**
     * Creates new form diplomaAlerts
     */
    public diplomaAlerts(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public diplomaAlerts(java.awt.Frame parent, boolean modal, String message) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(400, 253));
        setMinimumSize(new java.awt.Dimension(400, 253));
        setResizable(false);

        jPanel1.setMaximumSize(new java.awt.Dimension(400, 253));
        ...
        jPanel1.add(lbl_cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 10, 50, 50));
        ...
        jPanel1.add(btnAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, 110, 40));

        scroll_text.setBorder(null);

        txt_message.setEditable(false);
        txt_message.setColumns(20);
        txt_message.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
        txt_message.setForeground(new java.awt.Color(102, 51, 0));
        ...
        jPanel1.add(scroll_text, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 60, 220, 140));

        lbl_btn_ok.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/message/btn-message-ok-sm.png"))); // NOI18N
        jPanel1.add(lbl_btn_ok, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, 120, 40));

        lbl_background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/message/diploma-background.png"))); // NOI18N
        jPanel1.add(lbl_background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(diplomaAlerts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                diplomaAlerts dialog = new diplomaAlerts(new javax.swing.JFrame(), true);
