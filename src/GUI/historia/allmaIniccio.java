 ...
 * @author WINDOWS
 */
public class allmaIniccio extends javax.swing.JFrame {

    /**
     * Creates new form allmaIniccio
     */
    public allmaIniccio() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(allmaIniccio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new allmaIniccio().setVisible(true);
            }
        });
    }
